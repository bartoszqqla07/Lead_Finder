...
public static class DemoDataSeeder
{
    ...
    [
        ...
        new("Oaza Day Spa", "ul. Sokolska 66", "salon-spa", "salon spa", "spa", LeadStatus.WordPress, "https://oaza-spa.example", "HTTP 200 · WordPress 5.8.1 (wp-content, wp-json)", 4.6, 134, IsWordPress: true),
        new("Ink Point Tattoo", "ul. Mickiewicza 20", "salon-tatuazu", "salon tatuażu", "tattoo", LeadStatus.WordPress, "https://inkpoint.example", "HTTP 200 · WordPress (wp-content, wp-includes)", 4.9, 421, IsWordPress: true),
        new("Gabinet Kosmetologii Derma+", "ul. Francuska 34", "gabinet-kosmetologii", "gabinet kosmetologii", "cosmetology", LeadStatus.WordPress, "https://derma-plus.example", "HTTP 200 · WordPress 4.9.8 (wp-content, wp-json) · brak HTTPS", 4.4, 61, OutreachStage.Client, "Umowa podpisana, start 1.10.", IsWordPress: true),
        new("Hair Loft", "ul. Dworcowa 9", "salon-fryzjerski", "salon fryzjerski", "hair", LeadStatus.HasWebsite, "https://hairloft.example", "HTTP 200 · Wix", 4.8, 290),
        new("Kosmetyka Natura", "ul. Kościuszki 88", "salon-kosmetyczny", "salon kosmetyczny", "beauty", LeadStatus.HasWebsite, "https://kosmetyka-natura.example", "HTTP 200 · nie rozpoznano CMS", 4.3, 35, OutreachStage.Rejected, "Mają agencję, nie są zainteresowani."),
